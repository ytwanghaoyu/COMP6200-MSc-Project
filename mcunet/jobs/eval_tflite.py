...
parser.add_argument('--tflite_path',
                    default='/home/ytwanghaoyu/PycharmProjects/tinyml/mcunet/assets/tflite/mcunet-5fps_imagenet.tflite',
                    help='path to tflite file for evaluation')
# dataset args.
...
def get_val_dataset(resolution):
    ...
    if args.dataset == 'imagenet':
        val_dataset = datasets.ImageFolder(args.val_dir, transform=transforms.Compose([
...
def eval_image(data):
    ...
    image_np = (image_np * 255 - 128).astype(np.int8)  # int8 np.array shape (1, 112, 112, 3)
