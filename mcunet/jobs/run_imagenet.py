...
import json
from mcunet.utils import DistributedMetric, accuracy
...
if hvd.rank() == 0:
    from mcunet.utils import count_net_flops
    ...
    with tqdm(total=len(train_loader),
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if args.mixup_alpha > 0:  # mix up training
                ...
                output = model(data)
                from mcunet.utils.pytorch_utils import cross_entropy_with_label_smoothing
