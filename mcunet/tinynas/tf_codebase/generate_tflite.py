#import tensSection 4.5: Inference on one image orflow as tf
    ...
    with tf.Graph().as_default() as graph:
        with tf.Session() as sess:
            def network_map(images):
                ...
                from mcunet.tinynas.tf_codebase.tf_model_zoo import ProxylessNASNets
...
if __name__ == '__main__':
    # a simple script to convert the model to tflite
    import sys
    sys.path.append('.')
    import json
